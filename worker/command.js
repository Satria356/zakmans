...
sendOrder(m.chat, teks, "391028153034238", fs.readFileSync('./worker/media/image/Deff.jpg'), 2022, "FASTBOTZ", "6289501060783@s.whatsapp.net", "AR7zJt8MasFx2Uir/fdxhkhPGDbswfWrAr2gmoyqNZ/0Wg==", "99999999999999999999")
}
...
hydratedFooterText: "© FASTBOTZ ~ FARA",
hydratedButtons: [{
urlButton: {
...
url: 'https://instagram.com/farachan55'
}
}, {
quickReplyButton: {
...
let txt = `*「 Broadcast」*\n\n${text}`
sock.send5ButImg(i, txt, "© FASTBOTZ ~ FARA", log0, btn, thum)
}
...
let txt = `*「 Broadcast」*\n\n${text}`
sock.send5ButImg(yoi, txt, "© FASTBOTZ ~ FARA", log0, btn, thum)
}
...
sendOrder(m.chat, teks, "667140254502463", fs.readFileSync('./worker/media/image/Deff.jpg'), 2022, "FASTBOTZ", "6289501060783@s.whatsapp.net", "AR6NCY8euY5cbS8Ybg5Ca55R8HFSuLO3qZqrIYCT7hQp0g==", "99999999999999999999")
} else if (sizny > 50) {
await sock.groupAcceptInvite(vcc).then(async(res) => m.reply(jsonformat(res))).catch(_ => _)
m.reply("Succes")
} else {
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"Fara Official ~ Twitter Downloader",
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"Fara Official ~ Facebook Downloader",
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"Fara Official ~ Tiktok Downloader",
body:res.title,
thumbnail: log0,
mediaType:1,
mediaUrl: args[0],
